 ...
 * 
 * Handles authorization for multiple clients (GitHub OAuth App or GitLab Application) each identified by CLIENT_ID. For each client, it requires two environment variables:
...
app.get("/healthcheck", async (req, res) => {
  consoleLog("Health check requested");
